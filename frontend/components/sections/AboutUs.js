...
const AboutUs = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-20 sm:mt-0 relative ">
        <div className="absolute left-[50%] top-[6%] translate-x-[-53%] sm:top-0 z-100 sm:hidden">
          <Image src={aboutUs} alt="" className="w-full h-auto" />
        </div>
        <div className="w-1/2 md:w-full me-8 hidden md:block">
          <Image
            priority={true}
        ...
        <h1 className="text-2xl text-primary font-thin text-center sm:text-lg sm:mt-2">
          Maximizing your investment opportunities
        </h1>
      </div>

      <div className="flex items-center justify-between w-full lg:flex-col mt-16 sm:mt-4">
        <div className="w-1/2 md:w-full me-8 sm:hidden">
          <Image
            priority={true}
            sizes="(max-width: 768px) 100vw,
                (max-width: 1200px) 50vw,
        ...
        <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
          <h1
            ...
            className="!text-5xl !text-left !text-primary font-normal
                xl:!text-xl lg:!text-center lg:!text-3xl md:!text-5xl sm:!text-xl sm:font-extrabold
                "
          >
          ...
          <p className="my-4 text-primary text-base font-medium md:text-sm sm:text-sm">
          ...
          <div className="sm:w-full flex items-center self-start mt-2 lg:self-center">
            <div
              className={`flex items-center justify-center bg-dark text-light p-2.5 px-12
                  ...
                  hover:dark:border-light md:p-2 md:px-4 md:text-base sm:text-center sm:w-full
                  `}
