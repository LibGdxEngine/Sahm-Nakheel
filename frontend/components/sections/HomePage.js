...
const HomePage = () => {
  return (
    <>
      <div className="flex items-center justify-between w-full lg:flex-col sm:flex-col-reverse relative">
        ...
        <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center z-10">
          <h1
            className="w-full !text-md !text-left !text-primary font-light
                xl:!text-2xl lg:!text-center lg:!text-3xl md:!text-3xl sm:!text-xs sm:mb-3"
          >
          ...
          <h1
            className="w-full !text-5xl !text-left !text-primary font-light
                xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-3xl sm:!text-xl
                "
          >
          ...
          <h1
            className="w-full !text-md !text-left !text-primary font-light
                xl:!text-2xl lg:!text-center lg:!text-3xl md:!text-xl sm:!text-xs
                "
          >
            Achieve an exceptional long-term ROI up to 50%
          </h1>

          <p className="my-4 text-base font-medium md:text-sm sm:text-xs sm:hidden">
            <br className="" />
          </p>
          <div className="flex items-center self-start mt-2 sm:mt-6 lg:self-center">
            <div
